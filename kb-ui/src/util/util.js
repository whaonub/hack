...
export const setTitle = function (title) {
    title = title ? `${title}——新云核心微服务快速开发框架` : '新云核心微服务快速开发框架';
...
export const resolveUrlPath = (url, name) => {
    ...
    let reqUrl = url;
    if (url.indexOf("#") != -1 && url.indexOf("http") == -1) {  //如果网址中包含 # 并且不包含 http
        const port = reqUrl.substr(reqUrl.indexOf(':')); //截取网址首次出现 ：之后的内容
