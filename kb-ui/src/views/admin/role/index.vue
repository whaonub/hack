<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-button class="filter-item"  @click="handleCreate" type="primary" icon="edit" v-if="roleManager_btn_add">添加
      </el-button>
    </div>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 99%">
      ...
      <el-table-column label="操作" width="220" header-align="center">
        <template slot-scope="scope">
          ...
          <el-button size="mini" plain type="info" plain @click="handlePermission(scope.row)" v-if="roleManager_btn_perm">权限
          </el-button>
        </template>
      </el-table-column>
